...
export const LESSONS: LessonDef[] = [
  {
    ...
    day: {
      ...
      news: 0, ...baseDay, vol: 0.0035, netMin: -2, netMax: 99, minDD: 3, minRally: 3,
    },
    ...
    beats: [
      ...
      { atSec: 14, text: "that push — an impulse. impulses retrace. count on it." },
      { atSec: 28, text: "the pullback held above the last low. buyers still in the room." },
  ...
  },
  {
    ...
    day: {
      ...
      news: 0, ...baseDay, vol: 0.004, netMin: -3, netMax: 6, minDD: 4, minRally: 5,
    },
  ...
  },
  {
    ...
    day: {
      ...
      news: 0, ...baseDay, vol: 0.0045, netMin: -4, netMax: 6, minDD: 5, minRally: 5,
    },
    controls: { trade: true, short: true, sizing: false },
    ghostPlan: true,
    beats: [
