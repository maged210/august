...
/** Max snapshots kept per idea (ring buffer). This cap was sized for a ~15-min
 ...
 *
 * Extremes (MFE/MAE) are tracked in dedicated fields, so trimming the ring
 * NEVER loses excursion truth — only old sparkline detail. */
