...
- NEVER store specific market prices, index levels, quotes, or figures (e.g. "NQ at 29,500", "VIX 18") — they go stale instantly and become wrong. Live market data lives on the desk surface, not in memory.
