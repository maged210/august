...
- [ ] **A2 (S) HUMAN** Install Claude Code on the rig — PowerShell: `irm https://claude.ai/install.ps1 | iex`, then `claude` in C:\dev\august, log in.
  DONE WHEN: `claude` opens in the repo.
